...
function ToggleDark() {
  ...
  return (
    <>
      <button
        className="flex h-16 w-16 items-center justify-center rounded-full bg-white 2xl:h-12 2xl:w-12"
        onClick={toggleDark}
      >
        <AnimatePresence initial={false}>
          {isDark ? (
            <motion.svg
              ...
              width="45px"
              height="45px"
              className="2xl:h-[30px] 2xl:w-[30px]"
            >
              {" "}
            ...
            <motion.svg
              ...
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              className="2xl:h-[35px] 2xl:w-[35px]"
            >
              <motion.path
