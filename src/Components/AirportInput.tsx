...
function AirportInput({
  ...
  return (
    <>
      <label
        className="font-subHeadings text-2xl font-medium -mb-4 xl:text-3xl xl:leading-none "
      ...
      {isListActive && (
        <ul
          className="overflow-y-scroll h-48 p-1 border border-accent rounded-md md:overflow-y-scroll"
          onClick={onClick}
        >
          <ElementLists
