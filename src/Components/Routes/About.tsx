...
function About() {
  return (
    <main className="px-4 py-7 sm:pt-32 xl:px-8">
      ...
      <div className="border border-s-4 dark:border-tertiary border-primary rounded-xl p-4 text-balanced my-4 dark:text-white md:grid md:grid-cols-2 2xl:w-[80%] 2xl:m-auto">
