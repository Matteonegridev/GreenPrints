    ...
    <main className="px-4 py-6 pt-8 dark:text-white">
      ...
      >
        <Logo
          ...
          fill="#50D890"
        />
        <h1 className="font-titleText bg-gradient-to-r from-primary to-secondary bg-clip-text text-4xl font-medium uppercase text-transparent md:ml-2 md:text-6xl md:leading-none 2xl:text-5xl">
          GreenPrints
        </h1>
      </motion.div>
      <motion.div
      ...
      <div className="pb-8 pt-8 xl:grid xl:grid-cols-2 xl:p-2 xl:pt-24 2xl:p-7 2xl:pt-14">
        ...
        <div className="xl:order-1 xl:place-content-center 2xl:pl-20">
          <h1 className="font-sub mb-1 pl-2 pr-2 text-2xl font-bold uppercase md:text-4xl xl:text-5xl 2xl:text-6xl">
            <Trans
              i18nKey="mainTitle"
              components={{
          ...
          <p className="font-textBody text-pretty pl-2 pr-2 text-base md:pt-4 md:text-xl 2xl:text-base">
            <Trans
